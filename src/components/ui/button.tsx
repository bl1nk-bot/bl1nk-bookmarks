...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        cta:
          "bg-cta text-cta-foreground shadow-md hover:bg-cta/90 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0",
        secondary:
        ...
        glass:
          "bg-white/70 dark:bg-slate-900/70 backdrop-blur-lg border border-white/50 dark:border-white/10 text-foreground shadow-md hover:bg-white/80 dark:hover:bg-slate-900/80 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0",
      },
      size: {
